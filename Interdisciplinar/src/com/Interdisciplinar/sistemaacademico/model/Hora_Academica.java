...
public class Hora_Academica {
	...
	public Hora_Academica(int id_hora_academica,int fk_horario, String dia, int hora_inicio, int minuto_inicio, int hora_final,int minuto_final) {
